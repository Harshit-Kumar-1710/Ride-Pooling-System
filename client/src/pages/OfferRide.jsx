...
const OfferRide = () => {
  ...
  const [origin, setOrigin]                 = useState({ lat: defaultCampusData.lat, lng: defaultCampusData.lng, label: defaultCampusData.label });
  ...
  // Re-center map and update origin whenever campus selection changes
  useEffect(() => {
    const data = GEU_CAMPUSES[selectedCampus] || defaultCampusData;
    setMapCenter([data.lat, data.lng]);
    setOrigin({ lat: data.lat, lng: data.lng, label: data.label });
  }, [selectedCampus]);
