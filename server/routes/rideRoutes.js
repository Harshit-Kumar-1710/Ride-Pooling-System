...
const {
  ...
  getRideById, cancelRide, completeRide, searchRides, getRecommendedRides,
  optimizeRoute
...
router.get('/recommended',    verifyToken, getRecommendedRides);
router.post('/search',        verifyToken, searchRides);
router.get('/:id/optimize',   verifyToken, optimizeRoute);
